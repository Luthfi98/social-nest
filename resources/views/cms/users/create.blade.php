        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body py-3">
                    <form action="{{ route('cms.users.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password" class="small">{{ __('Password') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm @error('bio') is-invalid @enderror" 
                                              ...
                                              placeholder="{{ __('Enter user bio...') }}">{{ old('bio') }}</textarea>
                                    @error('bio')
                                        <div class="invalid-feedback small">{{ $message }}</div>
                                    @enderror
                                </div>
